...
import { LayoutDashboard, Users, Calendar, LogOut, Lock, Video, Library, Folder, ClipboardCheck, ChevronDown } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const menuItems = [
    ...
    { icon: <ClipboardCheck size = { 20 } />, text: 'Exam list', path: '/admin-exam-list' },
    {
      icon: <Library size={20} />,
      text: 'Courses',
      subItems: [
        { icon: <Library size={20} />, text: 'Register Course', path: '/regCourse' },
        { icon: <Library size={20} />, text: 'View Courses', path: '/admin-courses' },
      ],
    },
