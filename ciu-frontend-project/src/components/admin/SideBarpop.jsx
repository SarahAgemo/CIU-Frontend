...
//   }, [location, setActiveItem]);
  ...
  //   if (dropdownName === 'Manage Users') {
  //     setExamsDropdownOpen((prevState) => !prevState);
  //   } else if (dropdownName === 'Courses') {
...
//     setActiveItem(label);
//     if (label === "Courses") {
//       setExamsDropdownOpen(!isExamsOpen);
//     } else if (label === "Manage Users") {
//       setCoursesDropdownOpen(!isManageUsersOpen); // Toggle the "Manage Users" submenu
//     } else {
//       toggleMenu();
//     }
//   };
...
//                 </div>
//                 {((item.text === 'Manage Users' && isExamsDropdownOpen) ||
//                   (item.text === 'Courses' && isCoursesDropdownOpen)) && (
