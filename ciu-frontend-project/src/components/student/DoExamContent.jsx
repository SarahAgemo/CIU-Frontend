...
//             // Fetch existing exam progress
//             const response = await axios.get(`http://localhost:3000/api/exam-progress/${student.id}/${exam.id}`);
//             if (response.status === 200 && response.data) {
//                 const progress = response.data;

//                 if (progress.status === "in-progress") {
//                     const resume = window.confirm(
//                         "You have an ongoing attempt for this exam. Do you want to resume?"
//                     );

//                     if (!resume) return;

//                     navigate("/proctoring", { state: { exam, progress } });
//                     return;
//                 }
//             }
...
//         } catch (error) {
//             console.error("Error fetching exam progress:", error.message);
//             alert("An error occurred while attempting to load the exam.");
//         }
//     };
